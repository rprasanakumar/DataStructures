 ...
 */
public class StackArrayImplementation2<AnyType> implements StackInterfacing<AnyType> {
     ...
     */
    public StackArrayImplementation2(int initialCapacity)
    {
     ...
     */
    public StackArrayImplementation2()
    {
    ...
    {
        StackArrayImplementation2<Integer> s = new StackArrayImplementation2<Integer>(6);
    ...
    interface StackInterfacing<AnyType>
    {
        /**
         * Tests if the stack is empty.
         */
